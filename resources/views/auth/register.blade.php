    ...
    <body class="  general-bgcolor vh-100 overflow-hidden">
        ...
        <main class="vh-100 d-flex justify-content-center align-items-center">
            <div class="container mb-5">
                <div class="row my-5 align-items-center justify-content-start">
                    <div class="col-6 d-flex justify-content-start">
                        <div class="section-login-bgcolor px-5 py-4  ">
                            <div class="d-flex justify-content-center mb-4 mt-3">
    
                                <img style="width: 60%"  src="{{URL::asset('/img/logo-orizzontale-giallo.jpeg')}}" alt="">
                            </div>
                            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3 row d-flex align-content-between">
                                    <!-- Name -->
                                    <div class="col-6">
                                        <label class="mb-1 label-form" for="name">Nome</label>
                                        <input class="form-control shadow-input" type="text" name="name" id="name"value="{{old('name')}}" required>
                                        <x-input-error :messages="$errors->get('name')" class="mt-2" /> 
                                    </div>

                                    <!-- Surname -->
                                    <div class="col-6">
                                        <label class="mb-1 label-form" for="surname">Cognome</label>
                                        <input class="form-control shadow-input" type="text" name="surname" id="surname"value="{{old('surname')}}" required>
                                ...
                                <div class="form-group mb-3 row d-flex align-content-between">
                                    <!-- Region -->
                                    <div class="col-6">
                                        <label class="mb-1 label-form" for="region">Regione</label>
                                        <select class="form-control shadow-input mt-1" name="region" id="region">
                                            <option value=""></option>
                                    ...
                                    <!-- City -->
                                    <div class="col-6">
                                        <label class="mb-1 label-form" for="city">Città</label>
                                        <input class="form-control shadow-input " type="text" name="city" id="city" value="{{old('city')}}">
                                ...
                                <div class="form-group mb-3 row d-flex align-content-between">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input class="form-control shadow-input" type="email" name="email" id="email"value="{{old('email')}}" placeholder="" value="{{ old('email')}}" required/>
                                        <x-input-error :messages="$errors->get('email')" class="mt-2" />    
                                    </div>
                                    <!-- Phone -->
                                    <div class="col-6">
                                        <label class="mb-1 label-form" for="phone">Telefono</label>
                                        <input class="form-control shadow-input input-number" type="number" name="phone" id="phone"value="{{old('phone')}}">
                                ...
                                <div class="form-group mb-3 row d-flex align-content-between">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="password" name="password" id="password" class="form-control shadow-input">
                                        <x-input-error :messages="$errors->get('password')" class="mt-2" />
                                    </div>
                                    <!-- Confirm Password -->
                                    <div class="col-6">
                                        <label class="mb-1 label-form" for="password_confirmation">Conferma password</label>
                                        <input type="password" name="password_confirmation" id="password_confirmation" class="form-control shadow-input">
                                ...
                                {{-- img --}}
                                <div class="mb-3">
                                    <label class="mb-1 label-form" for="img">Immagine profilo</label>
                                    <input type="file" name="img" id="img" class="form-control shadow-input">
                                ...
                                <div class="flex items-center justify-center mt-5">
                                    <p class="fs-register-text">Hai già un account?
                                        <a class="link-red" href="{{route('welcome')}}">
                                            Accedi
                                        </a>
                                    </p>
