    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-5  d-flex align-content-center flex-wrap">
                ...
                <div class="w-100 mt-3 text-font text-color">
                    <span class="pe-3 fs-4 ">Creati: <b>{{$createdEventsCount}}</b></span>
                    <span class="ps-3 fs-4">Preferiti: <b>{{$savedEventsCount}}</b></span>
                </div>
               
            </div>
            <div class="col-3  d-flex align-items-center">
                <a class="" href="{{route('profile.edit')}}">
                    <button class="button-font button-bgcolor btn-edit-profile">
                        Modifica profilo
                    </button>
                </a>
            </div>
